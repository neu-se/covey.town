...
export default class TicTacToeGame extends Game<TicTacToeGameState, TicTacToeMove>{
    ...
    private checkForGameEnding(): boolean {
    ...
    private validateMove(move: TicTacToeMove) {
        ...
        if (this.state.status !== 'IN_PROGRESS') {
            throw new InteractableCommandError('Game is not in progress');
        }
    }
    ...
    public applyMove(move: GameMove<TicTacToeMove>): void {
        ...
        if (move.playerID === this.state.x) {
            ...
            throw new InteractableCommandError('Player is not in this game');
        }
    }
    public _join(player: Player): void {
        if (this.state.x === player.id || this.state.o === player.id) {
            throw new InteractableCommandError('Player is already in the game');
        }
        if (!this.state.x) {
            ...
            throw new InteractableCommandError('Game is full');
        }
