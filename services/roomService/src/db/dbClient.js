    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [4 /*yield*/, insertUser(client, record8)];
        case 3:
          _a.sent();
          return [4 /*yield*/, getOnlineStatus(client, 'cs@gmail.com')];
        case 4:
          s = _a.sent();
          console.log('status:', s);
          return [4 /*yield*/, setStatusOffline(client, 'cs@gmail.com')];
        case 5:
          _a.sent();
          return [4 /*yield*/, getOnlineStatus(client, 'cs@gmail.com')];
        case 6:
